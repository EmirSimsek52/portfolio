...
function Atom(props) {
  ...
  return (
    <group {...props}>
      <Line worldUnits points={points} color="#019CDE" lineWidth={0.3} />
      <Line worldUnits points={points} color="#019CDE" lineWidth={0.3} rotation={[0, 0, 1]} />
      <Line worldUnits points={points} color="#019CDE" lineWidth={0.3} rotation={[0, 0, -1]} />
      ...
      <Sphere args={[0.55, 64, 64]}>
        <meshBasicMaterial color={[1, 4, 10]} toneMapped={false} />
      </Sphere>
    </group>
  )
}
